...
prob_predictions <- predict(rf_model, newdata = drugs_test, type = "prob")
...
performance_summary <- data.frame(
  Metric = c("Accuracy", "Kappa", 
             "Non_user Balanced Accuracy", "Occasional_user Balanced Accuracy", "Frequent_user Balanced Accuracy",
             "Non_user F1 Score", "Occasional_user F1 Score", "Frequent_user F1 Score"),
