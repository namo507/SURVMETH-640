...
data <- read.csv("/Users/namomac/Downloads/92-21-income_expenditure_table_positions.csv", stringsAsFactors = FALSE)
names(data)
```
...
load_process_data <- function() {
  ...
  raw_data <- read.csv("/Users/namomac/Downloads/92-21-income_expenditure_table_positions.csv") %>%
    mutate(
