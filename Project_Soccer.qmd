...
# Then use the correct column name in your summarize function
winners_summary <- winners %>% 
  group_by(club) %>% 
  summarise(
    total_wins = n(),
    # Replace expenditure_m with the actual column name from your data
    # This might be "Expenditure", "expenditure", or something similar
